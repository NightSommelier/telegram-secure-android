...
Before the module receives carrier parsing, identity/session code or an upstream message integration adapter, `docs/secure-overlay-protocol-v1.md` must complete independent cryptographic review and the acceptance gates in `FORK.md` must be satisfied.
